   ...
   <div class="empty">
       ...
       <script type="text/javascript">
         ...
         $('#print').tooltip('hide');
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
      <a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="dashboard_client.php?module=list_barang_tidakdipakai"><i class="icon-arrow-left"></i> Back</a></p>   
      <script type="text/javascript">
      $(document).ready(function(){
      $('#return').tooltip('show');
      $('#return').tooltip('hide');
  ...
  mso-bidi-font-size:11.0pt;font-family:"Times New Roman","serif"'><o:p>&nbsp;</o:p></span></b></p>
   ...
   <?php  
          ...
          while ($row = mysql_fetch_assoc($barang)) {
            ...
            $jum=mysql_num_rows(mysql_query("select*from stdevice where dev_status='Dump'")); 
?>  
 </tr>
