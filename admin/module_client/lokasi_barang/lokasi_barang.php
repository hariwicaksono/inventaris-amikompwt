...
<div class="navbar navbar-inner block-header">
	<div class="pull-left"><i class="icon-reorder icon-building"></i> <?php echo $lang['admin']['list_location_disp']?></div>
...
<div class="span12">
	<ul	 id="da-thumbs" class="da-thumbs">
		...
		<li id="del<?php echo $id; ?>">
				<a href="?module=lokasi_barang_client&act=list&stdev_id=<?php echo $stdev_id?>">
...
<a href="?module=lokasi_barang_client" class="btn btn-info"  id="return" data-placement="right" title="$lang['admin']['click_back']" ><i class="icon-arrow-left"></i> <?php echo $lang['admin']['back']?></a>
...
<a class="btn btn-default pull-right" id="print" data-placement="left" title="<?php echo $lang['admin']['click_print_list']?>" href="print_lokasi_client.php<?php echo '?stdev_id='.$get_id; ?>" class="btn btn-info"><i class="icon-print"></i> <?php echo $lang['admin']['print_list']?></a>	
<script type="text/javascript">
$(document).ready(function(){
$('#print').tooltip('show');
$('#print').tooltip('hide');
...
?>
<li class="active">
<a href="?module=lokasi_barang_client"><?php echo $lang['admin']['all']?>&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
...
LEFT JOIN stdevice ON location_details.id = stdevice.id
LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id where stdevice.dev_id=$row[dev_id] and dev_status!='Dump'");
$count=mysql_num_rows($data);
?><li>
<a href="?module=lokasi_barang_client&act=list2&stdev_id=<?php echo $get_id?>&dev_id=<?php echo $row['dev_id']?>"><?php echo $row['dev_name'];?>&nbsp;
<span class='label label-default'><?php echo $count;?></a></li>
<?php
}
?>
</ul>
...
<th><?php echo $lang['admin']['input_unit']?></th>
<th>Status</th>	
...
<td width="185" class="empty"><a rel="tooltip"  title="Update Status" id="t<?php echo $id; ?>" href="?module=lokasi_barang_client&act=devl_update_status&stdev_id=<?php echo $get_id?>&id=<?php echo $id?>" class="btn btn-small btn-success"><i class="icon-upload-alt"></i> Status</a> 
...
<a href="?module=lokasi_barang_client" class="btn btn-info"  id="return" data-placement="right" title="<?php echo $lang['admin']['click_back']?>" ><i class="icon-arrow-left icon-large"></i> <?php echo $lang['admin']['back']?></a>
<script type="text/javascript">
$(document).ready(function(){
$('#return').tooltip('show');
$('#return').tooltip('hide');
...
<div id="block_bg" class="block">
<div class="navbar navbar-inner block-header">							
<div class="muted pull-left"><i class="icon-building"></i>  <?php echo $location_row['stdev_location_name']; echo">>$row[dev_name]"; ?> </div>
...
<a rel="tooltip"  title="Update Status" id="t<?php echo $id; ?>" href="?module=lokasi_barang_client&act=devl_update_status&stdev_id=<?php echo $get_id?>&id=<?php echo $id?>" class="btn btn-small btn-success"><i class="icon-upload-alt"></i> Status</a>
...
<div id="block_bg" class="block">
	<div class="navbar navbar-inner block-header">
		...
		<a id="return" data-placement="left" title="<?php echo $lang['admin']['click_back']?>" href="?module=lokasi_barang_client&act=list&stdev_id=<?php echo $stdev_id ?>"><i class="icon-arrow-left"></i> <?php echo $lang['admin']['back']?></a>
		</div>
		<script type="text/javascript">
		$(document).ready(function(){
		$('#return').tooltip('show');
	...
	?>
		...
		window.location = "?module=lokasi_barang_client&act=list&stdev_id=<?php echo $stdev_id?>"; 
...
<div id="block_bg" class="block">
	<div class="navbar navbar-inner block-header">
		...
		<a id="return" data-placement="left" title="Click to Return" href="?module=lokasi_barang_client&act=list&stdev_id=<?php echo $stdev_id ?>"><i class="icon-arrow-left"></i> Back</a>
		</div>
		<script type="text/javascript">
		$(document).ready(function(){
		$('#return').tooltip('show');
	...
	?>
		...
		if ($_POST['pindah']>$tampil['jumlah']){
			...
			$.jGrowl("Jumlah Barang Terlalu Banyak", { header: 'Error' });
				windows.location='?module=lokasi_barang_client&act=transfer&stdev_id=<?php echo $stdev_id?>&id=<?php echo $get_id?>';
			</script>
			<?php
		}else{
