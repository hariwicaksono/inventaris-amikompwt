...
<div id="block_bg" class="block">
		<div class="navbar navbar-inner block-header">
				<div class="pull-left"><i class="icon-check"></i>&nbsp;<?php echo $lang['admin']['unused_items']?></div>
				<div class="pull-right">
...
<li class="active">
	<a href="?module=barang_tidakdipakai"><?php echo $lang['admin']['all']?></a>
</li>
<li class="dropdown">
...
<?php
	...
	while ($row = mysql_fetch_assoc($barang)) {
		...
		$count=mysql_num_rows($data);  
						?>	
<li>
	<a href="?module=barang_tidakdipakai&act=list&dev_id=<?php echo $row['dev_id']?>"><?php echo $row['dev_name'];?>
...
<?php
		...
		where a.dev_id=b.dev_id and a.dev_status='Dump' and b.dev_id='$dev_id' ORDER BY a.id DESC") or die(mysql_error());
	    while ($row = mysql_fetch_array($device_query)) {
		$id = $row['id'];
		?>
