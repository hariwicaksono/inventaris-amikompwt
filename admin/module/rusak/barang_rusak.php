...
<div id="block_bg" class="block">
	<div class="navbar navbar-inner block-header">
			<div class="pull-left"><strong><i class="icon-check"></i>&nbsp;<?php echo $lang['admin']['list_damage_dev']?></strong></div>
			<div class="pull-right">
...
<option value="?module=barang_rusak">
...
while ($row = mysql_fetch_assoc($barang)) {
	...
	$count=mysql_num_rows($data);  
					?>	
<option value="?module=barang_rusak&act=list&dev_id=<?php echo $row['dev_id']?>">
